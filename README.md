...
```
cd existing_repo
git remote add origin https://gitlab.cs.uni-duesseldorf.de/dbs/research/project/rapp/rapp-user-frontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.uni-duesseldorf.de/dbs/research/project/rapp/rapp-user-frontend/-/settings/integrations)
